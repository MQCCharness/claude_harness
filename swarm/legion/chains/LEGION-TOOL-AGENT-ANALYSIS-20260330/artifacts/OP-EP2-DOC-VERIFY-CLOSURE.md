...
本轮线上页与 MG 机制句一致，可指回 `docs.openclaw.ai` 当前正文 → **`EC-P1-TC`：PASS（A 级锚点，文档级）**。
...
清单 1～7 文档黑盒核对 **PASS**；**EC-P1-TC** 与军令状⑤ OpenClaw TC-B **PASS**（**文档级**，非安装实测 TC-E）。
